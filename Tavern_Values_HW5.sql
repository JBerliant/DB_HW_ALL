...
(600006, 'Despondent', 'Was looking for someone familiar with the dark arts','1244-02-14 15:21:00','1244-02-16 12:10:00'),
(600007, 'Paranoid', 'Acted like he owned the place.', '1244-03-18 19:40:03', '1244-03-20 09:14:32');
...
INSERT INTO tavern_item_sales (customer_id,item_sku,qty, total_sale,sale_datetime,tavern_id) VALUES
(600002, 33002, 1, 2*200, GETDATE(), 26463458),
(600007, 33009,4, 4*20, GETDATE(), 26426194);

select * from visitor_id
select * from tavern_supplies 
select* from tavern_item_sales
